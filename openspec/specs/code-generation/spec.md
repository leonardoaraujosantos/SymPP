...
## Purpose
Code-generation surface at SymPy parity: source printers (C/C++/Fortran/LaTeX/
Octave/Rust/Julia/MathML/GLSL), a Graphviz-`dot` tree printer and a SymPy-
compatible `srepr`, a structured codegen AST with CSE, and `lambdify`/`autowrap`
compile-to-native.
## Requirements
