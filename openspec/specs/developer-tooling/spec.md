...
## Purpose
Standardize the day-to-day developer workflows (build, the unit/integration
test split, examples, the Tier 1 + Tier 2 parity gate, benchmarks and docs)
behind a single discoverable `just` task runner over the existing CMake +
Catch2 toolchain.
